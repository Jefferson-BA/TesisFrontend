  ...
  return (
    <Card className="w-[420px] bg-[#181616] border-none shadow-[0_20px_50px_rgba(0,0,0,1)] text-white overflow-hidden rounded-[45px]">
      <CardHeader className="flex flex-col items-center space-y-6 pt-14 pb-10">
        {/* Contenedor del Icono con estilo "Gold" */}
      ...
      <CardContent className="px-10 pb-12">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          {/* Input de Correo - Estilo Light/Sky */}
          ...
          {/* Input de Contraseña - Estilo Light/Sky */}
          <div className="space-y-3">
            <Label className="text-[11px] font-bold uppercase tracking-[0.2em] text-zinc-600 ml-2">
              CONTRASEÑA
            </Label>
          ...
          <div className="pt-4">
            ...
            >
              {isPending ? <Loader2 className="animate-spin" /> : "Ingresar al Dashboard"}
            </Button>
          </div>
        </form>
      </CardContent>

      {/* Footer Gris Integrado al Diseño */}
      <CardFooter className="bg-[#181616] p-0 m-0 border-none">
        <div className="w-full py-8 flex justify-center items-center">
          <p className="text-[14px] text-zinc-300 font-medium">
            ¿No tienes una cuenta?{" "}
            <a href="/register" className="text-[#00df9a] font-bold hover:text-[#05ffa3] transition-colors ml-1">
              Regístrate aquí
            </a>
          </p>
        </div>
