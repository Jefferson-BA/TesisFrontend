...
export const ProductCard = ({ product, onView, onAdd }: ProductCardProps) => (
  <article
    className={cn(
      "group rounded-2xl overflow-hidden hover:-translate-y-2 transition-all duration-500 flex flex-col h-full animate-fade-in-up",
  ...
  >
    ...
    <div className="h-64 relative overflow-hidden bg-muted">
      ...
      <span className="absolute top-4 left-4 bg-card/80 backdrop-blur-md border border-ember/30 text-ember text-[9px] uppercase font-black tracking-widest px-3 py-1 rounded-lg">
    ...
    <div className="p-5 flex flex-col flex-grow justify-between space-y-4">
      ...
      <div className="pt-3 border-t border-border space-y-3">
        <div className="flex items-baseline justify-between">
          <span className="text-[10px] text-muted-foreground uppercase tracking-widest">Inversión</span>
