export const Contacto = () => {
  return (
    <section id="contacto" className="bg-[#120d0a] pt-28 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-zinc-400 mt-5 text-lg max-w-xl mx-auto font-light leading-relaxed">
            Estamos listos para transformar tu celebración en algo memorable. Escríbenos o visítanos.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* TARJETA: TELÉFONO */}
          <div className="group bg-[#0b0806] border border-[#3d2c1f]/50 rounded-3xl p-10 text-center hover:border-yellow-500/30 hover:scale-[1.01] transition-all duration-300 shadow-xl flex flex-col items-center">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#1c1510] to-[#120d0a] border border-[#3d2c1f] flex items-center justify-center text-yellow-500 mb-6 group-hover:border-yellow-500/40 transition-colors shadow-md">
      ...
      {/* FOOTER PREMIUM */}
      <footer className="border-t border-[#3d2c1f]/50 mt-28 bg-[#0b0806]/60 backdrop-blur-md relative z-10">
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-zinc-400 text-sm font-light leading-relaxed mt-2">
              Servicio de catering premium para eventos especiales. Especialistas en parrillas selectas, buffets árabes y refinada comida criolla.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm font-light text-zinc-400">
              <div>
                <p className="font-medium text-zinc-200">Lunes a Viernes</p>
                <p className="text-xs text-zinc-500 mt-0.5">10:00 AM - 8:00 PM</p>
              </div>
              <div>
                <p className="font-medium text-zinc-200">Sábados y Domingos</p>
                <p className="text-xs text-zinc-500 mt-0.5">11:00 AM - 9:00 PM</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-sm font-light text-zinc-400 mb-4 leading-relaxed">
              Mantente al tanto de nuestros banquetes e historias gastronómicas.
            </p>
