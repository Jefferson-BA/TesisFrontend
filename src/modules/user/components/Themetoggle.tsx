 ...
 * Convención Tailwind: clases base = modo claro, prefijo dark: = modo oscuro.
 * Requiere tailwind.config con darkMode: "class".
 */
  ...
  return (
    <button
      ...
      className="
        ...
        border border-[#d8c4a0] dark:border-[#3d2c1f]/60
        bg-[#f1e7d8] dark:bg-[#14100d]
    ...
    >
      <Sun
        className={`absolute h-4 w-4 text-amber-500 transition-all duration-500 ease-out ${
          isDark
            ? "translate-y-6 opacity-0 rotate-90"
